...
func _enter_tree():
	...
	add_custom_type("TBLoaderExtended", "TBLoader", preload("res://addons/tbloader/nodes/tbloader_ext.gd"), preload("res://addons/tbloader/icons/tbloader.svg"))
...
func _exit_tree():
	...
	remove_custom_type("TBLoaderExtended")
